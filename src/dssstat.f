      SUBROUTINE DSSSTAT (KEPTLS,KEPTRS,LRERR,NESIKL,NESIKR,NNTRTL,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DSSSTAT checks the status of each subinterval                    *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    DNEIGAB,DSETLRM,DSSMOVB                                          *
C*                                                                     *
C***********************************************************************
C
C==== arguments ========================================================
C
      INTEGER          KEPTLS,KEPTRS,LRERR,NESIKL,NESIKR,NNTRTL,
     &                 NNTRTR,NSINT,NSSIKL,NSSIKR,NTEIG
...
C
         ...
         NSRNG = DNEIGAB(NTEIG,RSINT(1,NTSINV+1),RSINT(6,NTSINV+1),EIG)
C
         IF      ( NSRNG .GT. NERNG ) THEN
C
C............... something went wrong ..................................
C
                 CALL DSETLRM (27,LRERR)
                 RETURN
C
...
C
                 CALL DSSMOVB (+1,NTSINV+1,NRSINT-1,ISINT,RSINT)
C
	         NRSINT = NRSINT - 1
C
         END IF
