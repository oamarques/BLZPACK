      SUBROUTINE STBCONV (JT,NVB,NSLS,NSRS,NSRLS,NSRRS,NULLD,BIGNUM,EPS,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    STBCONV looks for converged THETA's, the eigenvalues of (TB)     *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      REAL             BETA(NVB,NVB),RNORM(JT),S(JT,JT),THETA(JT)
C
C==== local variables ==================================================
C
      INTEGER          I,JEND,K,NRLZL,NRRZR,NSLZL,NSRZR
      REAL             BETJ,RSBND,TBNORM,ZETAL,ZETAR
...
C
            BETJ = SRESNRM(NVB,BETA,BIGNUM,S(JEND,I))
