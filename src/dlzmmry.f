      SUBROUTINE DLZMMRY (JLMAX,JLSET,JTMAX,NVB,NVSET,LTAU,NI,N,LCOMM,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DLZMMRY checks the workspace available                           *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      ...
      IF ( TEMP .NE. 0 ) CALL DSETLRM (23,LRERR)
      IF ( INFO .NE. 0 ) CALL DSETLRM (32,LRERR)
C
C.... find the minima ..................................................
C
