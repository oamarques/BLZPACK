      SUBROUTINE SSSICHK (LFILE,LPRNT,LRERR,LRMDE,LRWRN,NNEIG,NDEIG,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SSSICHK examines the inertia information                         *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    SLZPRT2,SSETLRM,SSETSSL,SSSBACK,SSSCHEK,SSSORGN                  *
C*                                                                     *
...
C  
     ...
     &                 NSIMAX,NSINT,NSLOG,NSRLS,NSRRS,NTEIG
      REAL             BIGNUM,EIGL,EIGR,ENDL,ENDR,ORIGIN,RADIUS,
     &                 SFARL,SFARR,SIGMA,TRUSTL,TRUSTR
C
      INTEGER          ISINT(2,*)
      REAL             EIG(*),RSINT(6,*),SSLOG(8,*),TIME(*)
C
C==== local variables ==================================================
C
...
C
      CALL SLZPRT2 (LFILE,LPRNT,NNEIG,NDEIG,NSIGMA,RSINT,
     &              ISINT,NSINT,ENDL,ENDR,SIGMA)
C
C.... check the subintervals ...........................................
C
      CALL SSSCHEK (LRERR,LRMDE,NESIKL,NESIKR,NNSPNT,NNTRTL,NNTRTR,
...
C
         CALL SSSORGN (LRMDE,LRWRN,NSIMAX,NESIKL,NESIKR,NEWSIG,
...
C
         CALL SSSBACK (LFILE,LPRNT,LRWRN,NSIMAX,NNEIG,NNSPNT,NNTRTL,
...
C
      IF ( NSLOG .GT. NRUNMX ) THEN
         CALL SSETLRM (7,LRWRN)
      ELSE
         CALL SSETSSL (0,0,NNEIG,0,ENDL,ENDR,SIGMA0,NSLOG,SSLOG,TIME)
      END IF
C
C.... check for failure ................................................
C
      IF ( NSFAIL .GE. 3 ) CALL SSETLRM (8,LRWRN)
C
      RETURN 
C
C**** end of SSSICHK ***************************************************
