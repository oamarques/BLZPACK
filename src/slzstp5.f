      SUBROUTINE SLZSTP5 (JL,JT,JTMAX,JTMIN,NVB,N,LCOMM,NPE,LFILE,
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    SLZCHEK,SLZPRT3,SSITIME,SSSTRSF,STBEIGP                          *
C*                                                                     *
C*  - BLAS kernel:                                                     *
C*                                                                     *
C*    SCOPY                                                            *
...
C
     ...
     &                 NSLS,NSRS,NSRLS,NSRRS,NULLDQ,NULLDR,NVB
      REAL             ABSETA,ABSTAU,BIGNUM,EPS,GRNRM,REPS,
     &                 SIGMA,THETA0,THETAL,THETAR,THRSH
      LOGICAL          EIGON,GNRZD,SLICE
C
      INTEGER          IWORK(*)
      REAL             BETAR(*),RITZ(*),RWORK(*),S(*),
     &                 TB(*),THETA(*),TIME(*)
C
C==== local variables ==================================================
C
...
C
         TIME0 = SSITIME(ZERO)
C
         CALL STBEIGP (JT,JTMAX,NVB,LRWRN,NSLS,NSRS,NSRLS,NSRRS,NULLDR,
...
C
         IF ( GNRZD ) CALL SSSTRSF (JT,1,RWORK,S,SIGMA,THETA0)
C
C....... check the numbers obtained so far .............................
C
         CALL SLZCHEK (JT,JTMAX,JTMIN,NVB,N,LCOMM,NPE,LRMDE,LRWRN,
...
C....... print information .............................................
C
         CALL SLZPRT3 (JL,JT,LFILE,LPRNT,IDXETA,IDXTAU,
