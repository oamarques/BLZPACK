      SUBROUTINE DQTBQ (JL,JT,NVB,NI,NRUN,LFILE,BASIS,ORTH,GNRZD)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    DQTBQ computes and prints the basis orthogonality level          *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      CALL DLZPRT5 (JL,JT,NVB,NRUN,LFILE,ORTH)
C
      RETURN 
C
C**** end of DQTBQ *****************************************************
