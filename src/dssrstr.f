      LOGICAL FUNCTION DSSRSTR (LRMDE,NESIKL,NESIKR,NEWSIG,NSLS,NSRS,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DSSRSTR checks for a restart with SIGMA (origin translation)     *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
