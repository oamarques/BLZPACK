      SUBROUTINE DBLZRBX (ISTOR,RSTOR,LFLAG,NVOPU,X,U,V,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DBLZRBX deals with the product (B)*(X)                           *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      CALL DLZNRMX (ISTOR(NVB)   ,ISTOR(LNI)   ,ISTOR(NI)    ,
