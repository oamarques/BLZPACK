      SUBROUTINE DUPTAU (LEIG,NTEIG,NVB,ALPHA,BMAXN,BMINN,DELTA,EIG,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DUPTAU updates bounds for the selective orthog. strategy         *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      ...
      DOUBLE PRECISION BMAXN,BMINN,ENDL,ENDR,EPS,EPS1,SIGMA,THETA0
      LOGICAL          GNRZD
C
      DOUBLE PRECISION ALPHA(NVB,NVB),DELTA(NVB,NVB),EIG(LEIG,2),
     &                 TAUQ(*),TAUR(*),WORK(*)
C
C==== local variables ==================================================
C
...
C
   ...
   20            CONTINUE
C
                 CALL DNORM2A (NVB,DELTA,WORK,EPS,SVMAX,SVMIN)
C
