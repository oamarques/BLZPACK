      SUBROUTINE SSORTH0 (LBLAS,LCOMM,LRERR,LEIG,LNI,NI,NSORTH,NTEIG,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SSORTH0 purges the starting vectors and sets TAU                 *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      INTEGER          FHNDL(*)
      REAL             BX(NI,*),EIG(LEIG,2),R(NI,NVB),TAUQ(*),
...
C
              ...
              ELSE
                 IX = 1
                 CALL SLZIOOP (FHNDL,LCOMM,LRERR,I,NI,X(1,IX),
     &                         'X ','GET')
                 IF ( LRERR .NE. 0 ) RETURN
              END IF
C
