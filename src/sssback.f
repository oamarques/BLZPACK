      SUBROUTINE SSSBACK (LFILE,LPRNT,LRWRN,NSIMAX,NNEIG,NNSPNT,NNTRTL,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SSSBACK checks whether SIGMA was applied too far                 *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
         ...
         NSFAIL = NSFAIL + 1
C
         IF ( NSINT .GT. NSIMAX ) CALL SSETLRM (10,LRWRN)
         IF ( SIBTST(4,LPRNT) ) CALL SLZPRT8 (LFILE,NSIGMA,SIGMA,SGNEW)
C
         SIGMA = SGNEW
C
      ELSE
