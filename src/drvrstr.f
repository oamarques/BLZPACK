      SUBROUTINE DRVRSTR (JT,NR,NVB,BIGNUM,REPS,ENDL,ENDR,RITZ,RNORM,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DRVRSTR identifies the quasi-converged Ritz vectors              *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      INTEGER          JT,NR,NVB
      DOUBLE PRECISION BIGNUM,ENDL,ENDR,REPS,SIGMA
      LOGICAL          GNRZD,SLICE
C
      INTEGER          IWORK(*)
      DOUBLE PRECISION RITZ(JT),RNORM(JT),S(JT,JT),SSUM(JT,NVB),RWORK(*)
C
C==== local variables ==================================================
C
      INTEGER          I,J,K,L
      DOUBLE PRECISION LOWER,SSCALE,TSSUM,UPPER,WMIN
C
C==== BLAS kernel ======================================================
C
...
C
   ...
   70 CONTINUE
C
C.... mark the entries of RNORM to be considered by DRVMNGR .............
C
      DO 90 I = 1,NR
         RNORM(I) = ZERO
   90 CONTINUE
