      SUBROUTINE STBEIGP (JT,JTMAX,NVB,LRWRN,NSLS,NSRS,NSRLS,NSRRS,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    STBEIGP solves the reduced eigenproblem (TB)*(S)=(S)*(THETA)     *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
     ...
     &                 NSRLS,NSRRS,NULLD,NVB
      REAL             BIGNUM,EPS,REPS,SIGMA,THETA0,
     &                 THETAL,THETAR,THRES,THRSH
      LOGICAL          FULL,GNRZD,OUTER,SLICE
C
      INTEGER          IWORK(*)
      REAL             BETA(NVB,NVB),RWORK(*),S(JT,JT),
...
C
      CALL STBTRID (JT,JTMAX,NVB,LRWRN,TB,S,THETA,RWORK,IWORK,FULL)
C
C.... look for converged eigenvalues ...................................
C
      CALL STBCONV (JT,NVB,NSLS,NSRS,NSRLS,NSRRS,NULLD,BIGNUM,EPS,REPS,
