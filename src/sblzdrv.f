...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SBLZDRV is the user interface for a set of subprograms intended  *
...
C*             On the first call to SBLZDRV, the first 15 entries of   *
...
C*             the first call to SBLZDRV, the first 4 entries of       *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    SBLZEIG,SBLZEND,SBLZEXT,SBLZFCT,SBLZKLL,                         *
C*    SBLZRBX,SBLZSET,SBLZSTP,SBLZSTR                                  *
C*                                                                     *
C***********************************************************************
C*                                                                     *
...
C
              CALL SBLZEIG (ISTOR(IINIT),RSTOR(RINIT),LFLAG,SIGMA,NNEIG,
...
C............ finish ...................................................
C
              CALL SBLZEND (ISTOR(IINIT),RSTOR(RINIT),LFLAG,EIG,X,ABORT)
C
...
C
              CALL SBLZKLL (ISTOR(IINIT),RSTOR(RINIT),SIGMA,EIG,X,U)
C
              KLLON = .FALSE.
              AGAIN = .TRUE.
              ENDON = .TRUE.
...
C............ compute (B)*(X) ..........................................
C
              CALL SBLZRBX (ISTOR(IINIT),RSTOR(RINIT),LFLAG,NVOPU,
...
C
              CALL SBLZSTP (ISTOR(IINIT),RSTOR(RINIT),SIGMA,NNEIG,LFLAG,
...
C
              CALL SBLZSTR (ISTOR(IINIT),RSTOR(RINIT),SIGMA,LFLAG,
...
C
C............ SBLZDRV is called for the first time .....................
C
              CALL SBLZSET (ISTOR,RSTOR,ISTOR(IINIT),RSTOR(RINIT),
...
C
              CALL SBLZFCT (ISTOR(IINIT),RSTOR(RINIT),SIGMA,NNEIG,
...
C
      CALL SBLZEXT (ISTOR,RSTOR,LFLAG)
C
      RETURN 
C
C**** end of SBLZDRV ***************************************************
