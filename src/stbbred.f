      SUBROUTINE STBBRED (MB,N,A,D,E,Z,I0)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    STBBRED reduces a real symmetric band matrix to tridiagonal form *
C*                                                                     *
C*    STBBRED is a modified version of the EISPACK subroutine BANDR    *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
