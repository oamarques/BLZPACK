      SUBROUTINE DSSCHEK (LRERR,LRMDE,NESIKL,NESIKR,NNSPNT,NNTRTL,
     &                    NNTRTR,NREIG,NREIGL,NREIGR,NSSIKL,NSSIKR,
     &                    NTEIG,EIG,EIGL,EIGR,ORIGIN,SIGMA,INDSI,
     &                    NSINT,RSINT,ISINT,TRUSTL,TRUSTR)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    DSSCHEK checks convergence in all subintervals                   *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    DSSCLSD,DSSSLCT,DSSSTAT                                          *
C*                                                                     *
C***********************************************************************
C
C==== arguments ========================================================
C
      INTEGER          INDSI,LRERR,LRMDE,NESIKL,NESIKR,NNSPNT,
     &                 NNTRTL,NNTRTR,NREIG,NREIGL,NREIGR,
     &                 NSINT,NSSIKL,NSSIKR,NTEIG
      DOUBLE PRECISION EIGL,EIGR,ORIGIN,SIGMA,TRUSTL,TRUSTR
C
      INTEGER          ISINT(2,*)
      DOUBLE PRECISION EIG(*),RSINT(6,*)
C
C==== local variables ==================================================
C
...
C
      CALL DSSSTAT (KEPTLS,KEPTRS,LRERR,NESIKL,NESIKR,NNTRTL,
...
C
      CALL DSSCLSD (LRMDE,NNSPNT,NNTRTL,NNTRTR,NREIG,NREIGL,
     &              NREIGR,NSINT,NSLXI,NSRXI,NTEIG,EIG,
     &              EIGL,EIGR,ORIGIN,TRUSTL,TRUSTR)
C
C.... select a subinterval to work on ..................................
C
      CALL DSSSLCT (KEPTLS,KEPTRS,LRMDE,NREIGL,NREIGR,NSLXI,
