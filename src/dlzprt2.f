      SUBROUTINE DLZPRT2 (LFILE,LPRNT,NNEIG,NDEIG,NSIGMA,RSINT,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DLZPRT2 prints the computational subintervals                    *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C==== arguments ========================================================
C  
      INTEGER          LFILE,LPRNT,NDEIG,NNEIG,NSIGMA,NSINT
      DOUBLE PRECISION ENDL,ENDR,SIGMA
C  
      INTEGER          ISINT(2,NSINT)
      DOUBLE PRECISION RSINT(6,NSINT)
C
C==== local variable ===================================================
C
      INTEGER          I
