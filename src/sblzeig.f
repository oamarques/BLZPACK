      SUBROUTINE SBLZEIG (ISTOR,RSTOR,LFLAG,SIGMA,NNEIG,EIG,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SBLZEIG deals with the converged eigenvalues and eigenvectors    *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    SRVMNGR,SSETLRM,SSETSSL,SSITIME,SSSBEXT,                         *
C*    SSSCHEK,SSSORGN,SSSSPEC,SSSTRSF,STBEIGP                          *
C*                                                                     *
...
C
              CALL SSSSPEC (ISTOR(JT)    ,ISTOR(LFILE) ,ISTOR(LPRNT) ,
...
C
              CALL SSSBEXT (ISTOR(NSINT) ,RITZL        ,RITZR        ,
     &                      SIGMA        ,SIGMAL       ,SIGMAR       ,
     &                      RSTOR(RSINT) )
C
C............ check the subintervals ...................................
C
              CALL SSSCHEK (ISTOR(LRERR) ,ISTOR(LRMDE) ,NESIKL       ,
...
C
              CALL SSSORGN (ISTOR(LRMDE) ,ISTOR(LRWRN) ,ISTOR(NSIMAX),
