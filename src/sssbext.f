      SUBROUTINE SSSBEXT (NSINT,RITZL,RITZR,SIGMA,SIGMAL,SIGMAR,RSINT)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    SSSBEXT tries to extend the bounds of the current subinterval    *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      INTEGER          NSINT
      REAL             RITZL,RITZR,SIGMA,SIGMAL,SIGMAR
C
      REAL             RSINT(6,*)
C
C==== local variables ==================================================
