      SUBROUTINE DBLZSTP (ISTOR,RSTOR,SIGMA,NNEIG,LFLAG,NVOPU,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DBLZSTP performs a Lanczos algorithm step                        *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    DLZHIST,DLZSTP1,DLZSTP2,DLZSTP3,DLZSTP4,                         *
C*    DLZSTP5,DLZSTP6,DSETSSL,SIBTST                                   *
C*                                                                     *
C***********************************************************************
C
C==== parameters =======================================================
...
C
         CALL DLZSTP1 (ISTOR(INDR)  ,ISTOR(JL)    ,ISTOR(JLMAX) ,
...
C
         CALL DLZSTP2 (ISTOR(INDR)  ,ISTOR(JL)    ,ISTOR(JLMAX) ,
...
C
         CALL DLZSTP3 (ISTOR(INDR)  ,ISTOR(JL)    ,ISTOR(JLMAX) ,
...
C
         CALL DLZSTP4 (ISTOR(INDR)  ,ISTOR(JL)    ,ISTOR(JTMAX) ,
...
C....... check convergence .............................................
C
         CALL DLZSTP5 (ISTOR(JL)    ,ISTOR(JT)    ,ISTOR(JTMAX) ,
...
C
         CALL DLZSTP6 (ISTOR(INDR)  ,ISTOR(NVB)   ,ISTOR(LNI)   ,
     &                 ISTOR(NI)    ,RSTOR(R)     ,U            ,
     &                 EIGON        ,GNRZD        )
C
C....... check the run history .........................................
C
         CALL DLZHIST (ISTOR(JL)    ,ISTOR(JT)    ,ISTOR(NVB)   ,
