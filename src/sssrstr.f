      LOGICAL FUNCTION SSSRSTR (LRMDE,NESIKL,NESIKR,NEWSIG,NSLS,NSRS,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SSSRSTR checks for a restart with SIGMA (origin translation)     *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      HOLDON = .FALSE.
C
C.... decide what to do based on the location of SIGMA .................
C
      IF      ( LRMDE .EQ. 4 ) THEN
C
