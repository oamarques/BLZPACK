      SUBROUTINE DSTARTR (LCOMM,LRERR,LNI,NI,NR,R,V)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    DSTARTR checks the starting vectors defined by the user          *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    DLZCOPY,DPIRED,IPIRED,DSETLRM                                    *
C*                                                                     *
C*  - BLAS kernel:                                                     *
C*                                                                     *
C*    DASUM                                                            *
...
C....... check for NaNs ................................................
C
         IF ( SUMV .NE. SUMV ) CALL DSETLRM (25,LRERR)
         CALL IPIRED ('MAX',1,LRERR,GERR,LCOMM,INFO)
         IF ( INFO .NE. 0 ) CALL DSETLRM (32,LRERR)
         IF ( GERR .NE. 0 ) CALL DSETLRM (25,LRERR)
C
C....... check for a zero V ............................................
C
         IF ( LRERR .EQ. 0 ) THEN
            CALL DPIRED ('MAX',1,SUMV,GSUM,LCOMM,INFO)
            IF ( INFO .NE. 0 ) CALL DSETLRM (32,LRERR)
            IF ( GSUM .EQ. 0 ) CALL DSETLRM (25,LRERR)
         END IF
C
   10 CONTINUE
C
C.... copy V into R ....................................................
C
      IF ( LRERR .EQ. 0 ) CALL DLZCOPY (LNI,NI,NI,NR,V,R)
C
      RETURN
C
C**** end of DSTARTR ***************************************************
