      SUBROUTINE SSSTRSF (NVAL,NVEC,RITZ,S,SIGMA,THETA0)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    SSSTRSF transforms the eigenvalue spectrum from [THETA]          *
C*    to [RITZ]                                                        *
C*                                                                     *
...
C
      CALL SEIGSRT (NVAL,NVEC,NVAL,RITZ,S)
C
      RETURN 
C
C**** end of SSSTRSF ***************************************************
