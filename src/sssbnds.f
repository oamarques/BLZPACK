      SUBROUTINE SSSBNDS (LRWRN,N,NNEIG,NDEIG,NFARL,NFARR,NNSPNT,NNTRTL,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SSSBNDS initializes the computational subintervals               *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    SNEIGAB,SSETLRM,SSETTO0,SSITIME,SSSMOVB                          *
C*                                                                     *
...
C
     ...
     &                 NSINT,NSRLS,NSRRS,NTEIG
      REAL             BIGNUM,EIGL,EIGR,ENDL,ENDR,ORIGIN,SFARL,SFARR,
     &                 SIGMA,THETA0,THETAL,THETAR,TRUSTL,TRUSTR
C
      INTEGER          ISINT(2,*)
      REAL             EIG(*),RSINT(6,*),TIME(*)
C
C==== local variables ==================================================
C
...
C
         ...
         SFARR  = SIGMA
C
         IF ( (NREIGL.EQ.0) .AND. (NREIGR.EQ.0) ) CALL SSETLRM (1,LRWRN)
C
         CALL SSETTO0 (NSIMAX*6,RSINT,1)
C
...
C.... update bounds ....................................................
C
      CALL SSSMOVB(-1,NSINT,INDSI+1,ISINT,RSINT)
C
      ISINT(2,INDSI  ) = NNEIG 
