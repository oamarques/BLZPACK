      SUBROUTINE SLZSTP6 (IR,NVB,LNI,NI,R,U,EIGON,GNRZD)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    SLZSTP6 sets (U) for reverse communication                       *
C*                                                                     *
...
C
         IF ( EIGON ) THEN
C
C.......... (U) <--- (Q), refinement of eigenvectors in SRVMNGR .........
C
            CALL SLZCOPY (NI, NI,NI,NVB,R(IR(1)),U)
C
         ELSE
C
C.......... (U) <--- op(B)*(Q), reverse communication ..................
C
            CALL SLZCOPY (NI,LNI,NI,NVB,R(IR(3)),U)
C
         END IF
C
      ELSE
