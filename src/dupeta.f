      SUBROUTINE DUPETA (J,AMAXN,BMAXN,BMINN,EPS1,ETAQ,ETAR) 
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    DUPETA updates bounds for the partial reorthog. strategy         *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      INTEGER          J
      DOUBLE PRECISION BMINN,EPS1
C
      DOUBLE PRECISION AMAXN(*),BMAXN(*),ETAQ(*),ETAR(*)
C
C
C==== local variables ==================================================
C
