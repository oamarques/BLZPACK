      SUBROUTINE DBLZFCT (ISTOR,RSTOR,SIGMA,NNEIG,EIG,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DBLZFCT updates all computational subintervals                   *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      ...
      SSLOG = ISTOR(ISSLOG)
C
C.... decide what to do based on NNEIG .................................
C
      IF ( NNEIG .LT. 0 ) THEN
C
C....... NNEIG cannot be negative ......................................
C
         CALL DSETLRM (24,ISTOR(LRERR))
C
      ELSE
C
C....... set bounds and number of required eigenpairs ..................
C
         CALL DSSBNDS (ISTOR(LRWRN) ,ISTOR(N)     ,NNEIG        ,
...
C
         CALL DSSICHK (ISTOR(LFILE) ,ISTOR(LPRNT) ,ISTOR(LRERR) ,
