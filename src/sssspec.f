      SUBROUTINE SSSSPEC (JT,LFILE,LPRNT,N,NEWSIG,NNEIG,NONEWS,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SSSSPEC examines the Ritz values spectrum                        *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    SLZPRT7,SIBTST,SSSSIGL,SSSSIGR                                   *
C*                                                                     *
...
C
     ...
     &                 NSLS,NSRS,NSRLS,NSRRS
      REAL             ENDL,ENDR,RADIUS,RITZL,RITZR,SFARL,SFARR,
     &                 SIGMA,SIGMAL,SIGMAR
C
      REAL             RITZ(JT),RNORM(JT)
C
C==== local variables ==================================================
C
...
C
              SIGMAL = SIGMA
C
              CALL SSSSIGL (JT,NRVL,NSLS,NSRLS,RITZ,SIGMAL,TGAP)
C
...
C
              SIGMAR = SIGMA
C
              CALL SSSSIGR (JT,NRVL,NSRS,NSRRS,RITZ,SIGMAR,TGAP)
C
...
C
      IF ( SIBTST(6,LPRNT) ) CALL SLZPRT7 (LFILE,RITZL,RITZR,
     &                                     SIGMAL,SIGMAR)
C
      RETURN 
C
