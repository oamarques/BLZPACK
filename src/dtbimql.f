      SUBROUTINE DTBIMQL (N,D,E,Z,I0,INFO)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    DTBIMQL finds the eigenpairs of a symmetric tridiagonal matrix   *
C*                                                                     *
C*    DTBIMQL is a modified version of the EISPACK subroutine IMTQL2   *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
