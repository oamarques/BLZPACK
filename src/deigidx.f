      SUBROUTINE DEIGIDX (INDXP,INDXS,NNEIG,NPEIG,NREIG,NTEIG,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DEIGIDX finds the closest or farthest converged eigenvalue       *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      ...
      DOUBLE PRECISION BIGNUM,EIGL,EIGR,ORIGIN
C
...
C
      ...
      INDXS = NNEIG + 1
C
C.... determine INDXP and INDXS (eigenpair indexes) ....................
C
C     INDXP is the index for printing purposes
C     INDXS is the algebraic index
C
      DO 20 I = 1,NREIG 
         K = 0
         BOUND = BIGNUM
