C***********************************************************************
C*                                                                     *
C*    blz_defaults.h is an include file that sets defaults for BLZPACK *
C*    and it is used by the subroutine _setdft.f. Changing the values  *
C*    below may require an update of the total workspace needed.       *
C*                                                                     *
C***********************************************************************
C
...
C        in the program unit calling D/SBLZDRV. The eigenvalues are
...
C        in the program unit calling D/SBLZDRV. The eigenvectors are
...
C        preserved upon succesful exit from D/SBLZDRV. The eigenvalues
