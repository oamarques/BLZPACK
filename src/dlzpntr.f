      SUBROUTINE DLZPNTR (OFFSET,IW,JLMAX,JTMAX,NVB,LTAU,NI,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DLZPNTR defines pointers for the work array                      *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C==== arguments ========================================================
C
      INTEGER   JLMAX,JTMAX,LTAU,NBXMAX,NI,NQMAX,NRUNMX,
     &          NSIMAX,NWBSY,NWMAX,NWMIN,NVB,OFFSET
C
      INTEGER   IW(18),LOPTS(*)
C
C==== local variable ===================================================
