      SUBROUTINE DTBBRED (MB,N,A,D,E,Z,I0)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    DTBBRED reduces a real symmetric band matrix to tridiagonal form *
C*                                                                     *
C*    DTBBRED is a modified version of the EISPACK subroutine BANDR    *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
