      SUBROUTINE DSSSLCT (KEPTLS,KEPTRS,LRMDE,NREIGL,NREIGR,NSLXI,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DSSSLCT selects a subinterval to be examined                     *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C==== arguments ========================================================
C
      INTEGER          INDSI,KEPTLS,KEPTRS,LRMDE,NREIGL,
...
C
              ...
              ELSE
                      J = INDXL
                      NSRNG = DNEIGAB(NTEIG,RSINT(1,J),RSINT(5,J),EIG)
