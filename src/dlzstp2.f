      SUBROUTINE DLZSTP2 (IR,JL,JLMAX,NVB,LNI,NI,LBLAS,LCOMM,LRERR,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DLZSTP2 factors (R) as (Q_{j+1})*(BETA_{j+1})                    *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    DIDENTY,DLZCOPY,DRFACTR,DSITIME                                  *
C*                                                                     *
...
C
      IF ( GNRZD ) THEN
         ...
         CALL DLZCOPY (LNI,NI,NI,NVB,V,R(IR(3)))
      END IF
C
      TIME0 = DSITIME(ZERO)
C
      CALL DIDENTY (NVB,BETAR)
C
      CALL DRFACTR (LBLAS(4),LCOMM,LRERR,LRWRN,NI,NVB,NULLDR,BETAR,
