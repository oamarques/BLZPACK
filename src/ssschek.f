      SUBROUTINE SSSCHEK (LRERR,LRMDE,NESIKL,NESIKR,NNSPNT,NNTRTL,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SSSCHEK checks convergence in all subintervals                   *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
     ...
     &                 NSINT,NSSIKL,NSSIKR,NTEIG
      REAL             EIGL,EIGR,ORIGIN,SIGMA,TRUSTL,TRUSTR
C
      INTEGER          ISINT(2,*)
      REAL             EIG(*),RSINT(6,*)
C
...
C
      CALL SSSSTAT (KEPTLS,KEPTRS,LRERR,NESIKL,NESIKR,NNTRTL,
...
C
      CALL SSSCLSD (LRMDE,NNSPNT,NNTRTL,NNTRTR,NREIG,NREIGL,
     &              NREIGR,NSINT,NSLXI,NSRXI,NTEIG,EIG,
     &              EIGL,EIGR,ORIGIN,TRUSTL,TRUSTR)
C
C.... select a subinterval to work on ..................................
C
      CALL SSSSLCT (KEPTLS,KEPTRS,LRMDE,NREIGL,NREIGR,NSLXI,
