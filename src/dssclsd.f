      SUBROUTINE DSSCLSD (LRMDE,NNSPNT,NNTRTL,NNTRTR,NREIG,NREIGL,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DSSCLSD checks whether all required eigenvalues were found       *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
     ...
     &                 NREIGR,NSINT,NSLXI,NSRXI,NTEIG
      DOUBLE PRECISION EIGL,EIGR,ORIGIN,TRUSTL,TRUSTR
C
...
C
                 ...
                 NSLXI = DNEIGAB(NTEIG,ORIGIN-RANGE,ORIGIN,EIG)
                 NSRXI = DNEIGAB(NTEIG,ORIGIN+RANGE,ORIGIN,EIG)
C
