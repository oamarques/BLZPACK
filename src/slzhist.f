      SUBROUTINE SLZHIST (JL,JT,NVB,NI,NPE,LFILE,LPRNT,LRERR,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SLZHIST checks the run history                                   *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    SLZPRT4,SQTBQ,SSETLRM,SIBTST                                     *
C*                                                                     *
C***********************************************************************
C
C==== arguments ========================================================
...
C
              NONEWS = NONEWS + 1
              IF ( NONEWS.EQ.3 ) CALL SSETLRM (6,LRWRN)
...
C
      ...
      ELSE IF ( JT.GT.50 .OR. JL.GT.NQMAX ) THEN
              CALL SSETLRM (16,LRWRN)
      ELSE
              CALL SQTBQ (JL,JT,NVB,NI,NRUN,LFILE,BASIS,WORK,GNRZD)
      END IF
C
C.... print general information ........................................
C
      CALL SLZPRT4 (JL,JT,LFILE,LPRNT,NSLS,NSRS,NSRLS,NSRRS,RITZ,SLICE)
C
