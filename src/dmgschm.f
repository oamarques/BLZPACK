      SUBROUTINE DMGSCHM (LBLAS,LCOMM,LRERR,NI,NVB,BR,R,
...
C
         ...
         END IF
C
         CALL DPIRED ('SUM',1,DOTP,ZETA,LCOMM,INFO)
...
C
                       IF ( I .LT. NVB ) THEN
                          DO 10 J = 1,NVB-I
                             ...
                             END IF
   10                     CONTINUE
                          CALL DPIRED ('SUM',NVB-I,WORK,BETA(I+1,I),
     &                                 LCOMM,INFO)
                          IF ( INFO .NE. 0 ) CALL DSETLRM (32,LRERR)
                          DO 20 J = I+1,NVB 
                             IF ( GNRZD ) THEN
