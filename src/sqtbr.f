      SUBROUTINE SQTBR (N,BQ,LDBQ,NCBQ,R,LDR,NCR,ALPHA,AMAX,
...
C
      ...
      REAL             AMAX
C
      REAL             ALPHA(NCBQ,NCR),BQ(LDBQ,NCBQ),
...
C
      END IF
C
      CALL SPIRED ('SUM',NCBQ*NCR,WORK,ALPHA,LCOMM,INFO)
