      SUBROUTINE STBIMQL (N,D,E,Z,I0,INFO)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    STBIMQL finds the eigenpairs of a symmetric tridiagonal matrix   *
C*                                                                     *
C*    STBIMQL is a modified version of the EISPACK subroutine IMTQL2   *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
