      SUBROUTINE SLZRANG (LRMDE,NDEIG,NPEIG,NREIG,NREIGL,NREIGR,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SLZRANG checks the computational interval set by the user        *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      ...
      REAL             BIGNUM,EIGL,EIGR,ENDL,ENDR,SIGMA,THETA0
      LOGICAL          GNRZD
C
      REAL             RANGE(2)
C
