      SUBROUTINE SPURGE (IDXETA,IDXTAU,JL,JLMAX,JT,NVB,LTAU,LNI,NI,N,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SPURGE performs reorthogonalizations                             *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    SPORTH,SREORTH,SRFACTR,SSORTH                                    *
C*                                                                     *
C*  - BLAS kernel:                                                     *
C*                                                                     *
C*    ISAMAX                                                           *
...
C
     ...
     &                 NTEIG,NULLDQ,NULLDR,NVB,NXMAX
      REAL             ABSETA,ABSTAU,EPS,EPS1,REPS
      LOGICAL          GNRZD
C
      INTEGER          FHNDL(*),LBLAS(*)
      REAL             ANORM(JLMAX,2),BASIS(*),BETAQ(*),BETAR(*),
...
C
            SORTON = .TRUE.
C
            CALL SSORTH (LBLAS(4),LCOMM,LRERR,LNI,NI,NSORTH,NTEIG,NVB,
...
C
            PORTON = .TRUE.
C
            CALL SPORTH (JL,NVB,NI,LBLAS,LCOMM,LRERR,NPORTH,NQMAX,
...
C
              CALL SRFACTR (LBLAS(4),LCOMM,LRERR,LRWRN,NI,NVB,
...
C
         CALL SREORTH (LBLAS,LCOMM,LRERR,LRWRN,NI,NVB,NULLDR,BQ,BR,Q,R,
