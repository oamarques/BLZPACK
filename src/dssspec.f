      SUBROUTINE DSSSPEC (JT,LFILE,LPRNT,N,NEWSIG,NNEIG,NONEWS,
     &                    NSLS,NSRS,NSRLS,NSRRS,ENDL,ENDR,RADIUS,
     &                    RITZ,RITZL,RITZR,RNORM,SFARL,SFARR,
     &                    SIGMA,SIGMAL,SIGMAR)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    DSSSPEC examines the Ritz values spectrum                        *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    DLZPRT7,SIBTST,DSSSIGL,DSSSIGR                                   *
C*                                                                     *
...
C
     ...
     &                 NSLS,NSRS,NSRLS,NSRRS
      DOUBLE PRECISION ENDL,ENDR,RADIUS,RITZL,RITZR,SFARL,SFARR,
     &                 SIGMA,SIGMAL,SIGMAR
C
      DOUBLE PRECISION RITZ(JT),RNORM(JT)
C
C==== local variables ==================================================
C
...
C
              SIGMAL = SIGMA
C
              CALL DSSSIGL (JT,NRVL,NSLS,NSRLS,RITZ,SIGMAL,TGAP)
C
...
C
              SIGMAR = SIGMA
C
              CALL DSSSIGR (JT,NRVL,NSRS,NSRRS,RITZ,SIGMAR,TGAP)
C
...
C
      IF ( SIBTST(6,LPRNT) ) CALL DLZPRT7 (LFILE,RITZL,RITZR,
     &                                     SIGMAL,SIGMAR)
C
      RETURN 
C
