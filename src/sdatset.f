      SUBROUTINE SDATSET (IPSET,RPSET,JLMAX,JTMAX,JTMIN,NVB,LEIG,LTAU,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SDATSET initializes variables                                    *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    SLZHEAD,SLZMMRY,SLZRANG,SSETLRM,SIBTST                           *
C*                                                                     *
...
C
      CALL SLZMMRY (JLMAX,NLSIN,JTMAX,NVB,NVBIN,LTAU,NI,N,LCOMM,NPE,
...
C
      ...
      END IF
C
      CALL SLZRANG (LRMDE,NDEIG,NPEIG,NREIG,NREIGL,NREIGR,BIGNUM,
...
C.... print header .....................................................
C
      IF ( SIBTST(1,LPRNT) ) CALL SLZHEAD (JLMAX,NVB,LTAU,N,LFILE,LRERR,
