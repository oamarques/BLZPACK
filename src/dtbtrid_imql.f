...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    DIDENTY,DSETLRM,DTBBRED,DTBCOPY,DTBIMQL                          *
C*                                                                     *
C*  - BLAS kernel:                                                     *
C*                                                                     *
C*    DCOPY                                                            *
...
C 
      IF ( NVB .GT. 1 ) THEN
         CALL DTBCOPY (HLFBND,N,JTMAX,TB,RWORK(1+N))
         CALL DTBBRED (HLFBND,N,RWORK(1+N),THETA,RWORK,S,I0)
      ELSE
...
C
      CALL DTBIMQL (N,THETA,RWORK(1),S,I0,INFO)
C
