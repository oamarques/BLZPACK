      SUBROUTINE SSSSTAT (KEPTLS,KEPTRS,LRERR,NESIKL,NESIKR,NNTRTL,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SSSSTAT checks the status of each subinterval                    *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
         ...
         NSRNG = SNEIGAB(NTEIG,RSINT(1,NTSINV+1),RSINT(6,NTSINV+1),EIG)
C
         IF      ( NSRNG .GT. NERNG ) THEN
C
C............... something went wrong ..................................
C
                 CALL SSETLRM (27,LRERR)
                 RETURN
C
...
C
                 CALL SSSMOVB (+1,NTSINV+1,NRSINT-1,ISINT,RSINT)
C
	         NRSINT = NRSINT - 1
C
         END IF
