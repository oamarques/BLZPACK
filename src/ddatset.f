      SUBROUTINE DDATSET (IPSET,RPSET,JLMAX,JTMAX,JTMIN,NVB,LEIG,LTAU,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    DDATSET initializes variables                                    *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C*  - Subprograms:                                                     *
C*                                                                     *
C*    DLZHEAD,DLZMMRY,DLZRANG,DSETLRM,SIBTST                           *
C*                                                                     *
...
C==== arguments ========================================================
C
      INTEGER          IBUSY,JLMAX,JTMAX,JTMIN,LCOMM,LEIG,LFILE,
     &                 LNI,LPRNT,LRERR,LRMDE,LTAU,MYPE,N,NBXMAX,
     &                 NDEIG,NI,NPEIG,NPE,NQMAX,NREIG,NREIGL,
     &                 NREIGR,NRUNMX,NSIMAX,NSVIN,NTEIG,
     &                 NVB,RBUSY
      DOUBLE PRECISION BIGNUM,EIGL,EIGR,ENDL,ENDR,EPS,EPS1,
     &                 REPS,SIGMA,THETA0,THRSH
      LOGICAL          AGAIN,STRON
C
      INTEGER          IPSET(*),LOPTS(*)
...
C
      CALL DLZMMRY (JLMAX,NLSIN,JTMAX,NVB,NVBIN,LTAU,NI,N,LCOMM,NPE,
...
C
      ...
      END IF
C
      CALL DLZRANG (LRMDE,NDEIG,NPEIG,NREIG,NREIGL,NREIGR,BIGNUM,
...
C.... print header .....................................................
C
      IF ( SIBTST(1,LPRNT) ) CALL DLZHEAD (JLMAX,NVB,LTAU,N,LFILE,LRERR,
