      SUBROUTINE SBLZFCT (ISTOR,RSTOR,SIGMA,NNEIG,EIG,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SBLZFCT updates all computational subintervals                   *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
         CALL SSETLRM (24,ISTOR(LRERR))
C
      ELSE
C
C....... set bounds and number of required eigenpairs ..................
C
         CALL SSSBNDS (ISTOR(LRWRN) ,ISTOR(N)     ,NNEIG        ,
...
C
         CALL SSSICHK (ISTOR(LFILE) ,ISTOR(LPRNT) ,ISTOR(LRERR) ,
