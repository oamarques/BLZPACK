      SUBROUTINE SQTBQ (JL,JT,NVB,NI,NRUN,LFILE,BASIS,ORTH,GNRZD)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    SQTBQ computes and prints the basis orthogonality level          *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C==== arguments ========================================================
C
      INTEGER          JL,JT,LFILE,NI,NRUN,NVB
      LOGICAL          GNRZD
C
...
C
      CALL SLZPRT5 (JL,JT,NVB,NRUN,LFILE,ORTH)
C
      RETURN 
C
C**** end of SQTBQ *****************************************************
