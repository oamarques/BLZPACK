      SUBROUTINE DSSBEXT (NSINT,RITZL,RITZR,SIGMA,SIGMAL,SIGMAR,RSINT)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    DSSBEXT tries to extend the bounds of the current subinterval    *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      INTEGER          NSINT
      DOUBLE PRECISION RITZL,RITZR,SIGMA,SIGMAL,SIGMAR
C
