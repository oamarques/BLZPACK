      SUBROUTINE SSSORGN (LRMDE,LRWRN,NSIMAX,NESIKL,NESIKR,NEWSIG,
...
C*  - Purpose:                                                         *
C*                                                                     *
C*    SSSORGN sets the origin translation                              *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      IF      ( SSSRSTR(LRMDE,NESIKL,NESIKR,NEWSIG,NSLS,NSRS,
...
C
                      CALL SSSSPLT (INDSI,SIGMA,RSINT)
C
                      LRMDE = 4
C
              END IF
