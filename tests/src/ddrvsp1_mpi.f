...
C***********************************************************************
C*                                                                     *
C*    DDRVSP1_MPI is a driver model for the standard eigenvalue        *
C*    problem                                                          *
C*                                                                     *
C*           (A)*(x) - eig*(x) = (0)                                   *
C*                                                                     *
C*    where (A) is a symmetric matrix of dimension N. DDRVSP1_MPI is   *
C*    the parallel, MPI based, version of DDRVSP1.                     *
C*                                                                     *
C*    Data for DDRVSP1_MPI is read from 'drvsp1.dat' (see below). The  *
