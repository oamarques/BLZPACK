      SUBROUTINE DPRTEIG (ISTOR,LEIG,LN,NI,EIG,X,W)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    DPRTEIG prints the contents of (EIG) and (X)                     *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      ...
      DO 10 I = 1,NTEIG
         CALL DPIGTR (NI,X(1,I),W,LCOMM,INFO)
         IF ( INFO .NE. 0 ) STOP '* DPRTEIG: global gather error'
