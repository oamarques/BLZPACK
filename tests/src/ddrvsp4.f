...
C***********************************************************************
C*                                                                     *
C*    DDRVSP4 is a driver model for the standard eigenvalue problem    *
C*                                                                     *
C*           (A)*(x) - eig*(x) = (0)                                   *
C*                                                                     *
...
C*                 | (v) |                                             *
C*                                                                     *
C*    Data for DDRVSP4 is read from the standard input (see below).    *
...
C
C............ starting vectors (DSIRAND is borrowed from BLZPACK) ......
C
              NRUN = NRUN + 1
              V(1,1) = DSIRAND(NRUN*2)
C
              DO 110 I = 1,NVOPU
                 DO 80 J = 1,MPN
                    V(J,I) = ZERO
