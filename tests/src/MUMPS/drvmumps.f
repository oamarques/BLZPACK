...
!***********************************************************************
!*                                                                     *
!*    DRVMUMPS is a driver model for the standard eigenvalue problem   *
!*                                                                     *
!*             (A)*(x)-eig*(x)=(0)                                     *
!*                                                                     *
!*    where (A) is a symmetric matrix of dimension N. DRVMUMPS is      *
!*    the parallel, MPI based, version of DRVGP1 calling MUMPS.        *
!*                                                                     *
!*    Data for DRVMUMPS are read from `drvmumps.dat' (see below).      *
!*    The upper triangle of (A) is read from the file MATRXA           *
!*    in coordinate format).                                           *
!*                                                                     *
!*    Examples: files `drvmumps.dat' and `A.dat'                       *
...
!....... read data .....................................................
!
         OPEN  (UNIT=10,STATUS='OLD',FILE='drvmumps.dat')
...
!............... early  finalization ...................................
!
                 IF ( MYPE==0 ) WRITE (*,'(/A)') 'BLZDRD: abnormal exit'
                 EXIT
!
...
!............... normal finalization ...................................
!
                 IF ( MYPE==0 ) WRITE (*,'(/A)') 'BLZDRD: standard exit'
                 EXIT
!
