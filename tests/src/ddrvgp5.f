...
C***********************************************************************
C*                                                                     *
C*    DDRVGP5 is a driver model for the generalized eigenvalue         *
C*    problem                                                          *
C*                                                                     *
C*            (A)*(x) - eig*(B)*(x) = (0)                              *
C*                                                                     *
...
C*                                                                     *
C*    Data for DDRVGP5 is read from the standard input (see below).    *
...
C
     ...
     &                 IW2(LN*2+2),JCN(MAXNE),KEEP(MAXNE+LN*5+2),N,NE
      DOUBLE PRECISION A(LN),B(MAXB),C(MAXB),CNTL(2),RINFO(4),RHO,W(LN)
