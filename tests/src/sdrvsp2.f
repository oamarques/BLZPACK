...
C***********************************************************************
C*                                                                     *
C*    SDRVSP2 is a driver model for the standard eigenvalue problem    *
C*                                                                     *
C*           (A)*(x) - eig*(x) = (0)                                   *
C*                                                                     *
C*    where (A) is a symmetric matrix of dimension N. SDRVSP2 uses     *
C*    eigenvalues/eigenvectors of (A) as input.                        *
C*                                                                     *
C*    Data for SDRVSP2 is read from the standard input (see below).    *
