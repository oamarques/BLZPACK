...
C***********************************************************************
C*                                                                     *
C*    SDRVGP3 is a driver model for the generalized eigenvalue problem *
C*                                                                     *
C*           (A)*(x) - eig*(B)*(x) = (0)                               *
C*                                                                     *
...
C*    same pattern of (A).                                             *
C*                                                                     *
C*    Data for SDRVGP3 is read from the standard input (see below).    *
...
C=======================================================================
C
C.... read data (see file 'drvgp3.dat') ................................
C
