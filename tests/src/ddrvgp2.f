...
C***********************************************************************
C*                                                                     *
C*    DDRVGP2 is a driver model for the generalized eigenvalue problem *
C*                                                                     *
C*           (A)*(x) - eig*(B)*(x) = (0)                               *
C*                                                                     *
...
C*    diagonal matrix.                                                 *
C*                                                                     *
C*    Data for DDRVGP2 is read from the standard input (see below).    *
...
C=======================================================================
C
C.... read data (see file 'drvgp2.dat') ................................
C
