      SUBROUTINE SPRTEIG (ISTOR,LEIG,LN,NI,EIG,X,W)
C
C***********************************************************************
C*                                                                     *
C*  - Purpose:                                                         *
C*                                                                     *
C*    SPRTEIG prints the contents of (EIG) and (X)                     *
C*                                                                     *
C*  - Arguments:                                                       *
C*                                                                     *
...
C
      ...
      DO 10 I = 1,NTEIG
         CALL SPIGTR (NI,X(1,I),W,LCOMM,INFO)
         IF ( INFO .NE. 0 ) STOP '* SPRTEIG: global gather error'
