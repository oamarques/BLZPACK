...
C***********************************************************************
C*                                                                     *
C*    SDRVSP1 is a driver model for the standard eigenvalue problem    *
C*                                                                     *
C*           (A)*(x) - eig*(x) = (0)                                   *
C*                                                                     *
C*    where (A) is a symmetric matrix of dimension N.                  *
C*                                                                     *
C*    Data for SDRVSP1 is read from the standard input (see below).    *
C*    The upper triangle of (A) is read from the file MATRXA (in       *
C*    coordinate format).                                              *
C*                                                                     *
C*    Examples: files 'sdrvsp1.dat' and 'A.dat'                        *
