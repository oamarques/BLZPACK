...
C***********************************************************************
C*                                                                     *
C*    DDRVSP2 is a driver model for the standard eigenvalue problem    *
C*                                                                     *
C*           (A)*(x) - eig*(x) = (0)                                   *
C*                                                                     *
C*    where (A) is a symmetric matrix of dimension N. DDRVSP2 uses     *
C*    eigenvalues/eigenvectors of (A) as input.                        *
C*                                                                     *
C*    Data for DDRVSP2 is read from the standard input (see below).    *
...
C*                                                                     *
C*    Examples: files 'drvsp2.dat', 'A.dat' and 'A_eig.dat'            *
C*                                                                     *
C***********************************************************************
C
C.... parameters .......................................................
